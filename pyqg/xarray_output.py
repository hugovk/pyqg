...
var_attr_database = {
    ...
    "v": {
        "long_name": "meridional velocity anomaly",
        "units": "meters per second",
    },
    "ufull": {
        "long_name": "zonal full velocities in real space",
        "units": "meters per second",
    },
    "vfull": {
        "long_name": "meridional full velocities in real space",
        "units": "meters per second",
    },
    "qh": {
        "long_name": "potential vorticity in spectral space",
        "units": "meters squared Kelvin per second per kilogram",
    },
    "uh": {
        "long_name": "zonal velocity anomaly in spectral space",
        "units": "meters per second",
    },
    "vh": {
        "long_name": "meridional velocity anomaly in spectral space",
        "units": "meters per second",
    },
    "ph": {
        "long_name": "streamfunction in spectral space",
        "units": "meters squared per second",
    },
    "Ubg": {
        "long_name": "background zonal velocity",
        "units": "meters per second",
    },
    "Qy": {
        "long_name": "background potential vorticity gradient",
        "units": "meters squared Kelvin per second per kilogram",
    },
}
...
coord_attr_database = {
    ...
    "lev_mid": {
        "long_name": "vertical level interface",
    },
    "x": {
        "long_name": "real space grid points in the x direction",
        "units": "grid point",
    },
    "y": {
    ...
    "l": {
        "long_name": "spectal space grid points in the l direction",
        "units": "meridional wavenumber",
    },
    "k": {
        "long_name": "spectal space grid points in the k direction",
        "units": "zonal wavenumber",
    },
}
...
transformations = {
    ...
    "lev_mid": lambda x: np.arange(1.5, x.nz + 0.5),
    "x": lambda x: x.x[0, :],
    "y": lambda x: x.y[:, 0],
    "l": lambda x: x.ll,
    "k": lambda x: x.kk,
...
def model_to_dataset(m):
    ...
    for diag_name in m.diagnostics:
        try:
            ...
            attrs = {
                "long_name": m.diagnostics[diag_name]["description"],
                "units": m.diagnostics[diag_name]["units"],
            }
